		...
		<div className='xl:flex xl:gap-10 p-12 bg-neutral-50 rounded-lg'>
			<div className="flex flex-col justify-between xl:flex-1">
				<div className="flex flex-col gap-3">
					...
					<p className='hidden xl:block'>santosha is a modern yoga studio where everyone can find their perfect practice. We've created a welcoming space with professional instructors to help you achieve harmony, strength, and flexibility.
						Our classes suit all levels—from beginners to advanced practitioners.</p>
				</div>
				<address className="hidden xl:flex xl:flex-col xl:gap-1">
					<p>Saint-Petersburg</p>
					<p>Peace st. 42</p>
					<a href="tel:+79002009090">
						+7 900 200 90 90
					</a>

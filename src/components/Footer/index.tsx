				...
				<footer className="w-full py-15 text-white bg-button-brown">
					<div className='px-20 pb-10 flex justify-between items-start gap-10'>
						<div className='flex-1'>
							...
							<p className='mt-5'>Find your balance and inner peace through mindful practice and expert guidance.</p>
						</div>
					...
					<p className='pt-10 flex-center'>© 2025 Santosha. All rights reserved.</p>
				</footer>
			)}
		</>
	);

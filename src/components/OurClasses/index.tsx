		...
		<section id="ourClasses" className="w-full bg-neutral-50 py-40">
			...
			>
				<div className="md:w-3/5">
					...
					<p className="text-paragraph-gray py-5 text-center">
						We offer different yoga styles for your growth and comfort.We offer
						different yoga styles for your growth and comfort.
					</p>
				</div>
			</motion.div>
			<motion.div
